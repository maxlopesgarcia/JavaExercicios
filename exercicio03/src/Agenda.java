...
class Agenda {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 2:
                    editarContatoPorNome(scanner, lista);
                    break;

                case 3:
                    excluirContatoPorNome(scanner, lista);
                    break;
    ...
    public static void menuPrincipal() {
        ...
        System.out.println("[2] Editar contato (por nome)");
    ...
    public static void editarContatoPorNome(Scanner scanner, ArrayList<Contato> lista) {
        ...
        for (Contato c : lista) {
            if (c.getNome().toLowerCase().equals(busca)) {
                contato = c;
                break;
            }
        }
    ...
    public static void excluirContatoPorNome(Scanner scanner, ArrayList<Contato> lista) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            if (lista.get(i).getNome().toLowerCase().equals(busca)) {
